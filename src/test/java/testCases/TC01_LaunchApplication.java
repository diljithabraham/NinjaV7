    ...
    public void testLaunchApplication() {
        ...
        try {
            if (getDriver() == null) {
                ...
                AssertJUnit.fail("WebDriver is null, cannot continue test.");
            }
            ...
            try {
                AssertJUnit.assertEquals(confirmation, "Qafox.com");
                ...
                AssertJUnit.fail("Homepage confirmation message mismatch: " + e.getMessage());
            }

        } catch (Exception e) {
            log.error("Unexpected error occurred during test execution: {}", e.getMessage(), e);
            AssertJUnit.fail("Test encountered an unexpected error: " + e.getMessage());
        }
